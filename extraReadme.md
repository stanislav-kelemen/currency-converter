### Ідея
  ...
  Зробити конвертер-калькулятор валют, який би використовував
...
постійно доступ.
- Функцію *конструктор* так само маю ще нереалізовану ідею використання
...
довести до ладу, розкласти в окремі файли та оптимізувати **в найближчі дні**, 
щоб це стало повноцінним пет-проектом, а не просто домашкою TC по JS :) 
Зараз просто по іншим лекціям мушу виконати завдання.
